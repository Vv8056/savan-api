...
export default class SavanApi {
  ...
  async _callByType(token, type) {
    switch (type.toLowerCase()) {
      ...
      // https://www.jiosaavn.com/api.php?__call=webapi.get&token=XdXk5YOm0QA_&type=album&includeMetaTags=0&ctx=wap6dot0&api_version=4&_format=json&_marker=0
      case "album":
        return this._get({
          __call: "webapi.get",
          token: token,
      ...
      // https://www.jiosaavn.com/api.php?__call=webapi.get&token=Oa5rVWYKK7k1jNjMCv,bnQ__&type=playlist&p=0&n=50&includeMetaTags=0&ctx=wap6dot0&api_version=4&_format=json&_marker=0
      case "playlist":
        return this._get({
          __call: "webapi.get",
          token: token,
